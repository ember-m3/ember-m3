...
class TestSchemaOldHooks extends DefaultSchema {
  ...
  computeAttributeReference(key, value, modelName, schemaInterface) {
    return computeAttributeReference(key, value, modelName, schemaInterface, this.models);
  }
  computeNestedModel(key, value, modelName, schemaInterface) {
    return computeNestedModel(key, value, modelName, schemaInterface, this.models);
  }
  computeBaseModelName(modelName) {
    let schema = this.models[modelName];
