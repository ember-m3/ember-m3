...
module('unit/projection', function(hooks) {
  ...
  module('property notifications on embedded objects', function(hooks) {
    ...
    skip(
      'Setting an embedded object property on a nested projection updates the base-record and other projections',
      function(assert) {
        let { baseRecord, projectedExcerpt, projectedPreview } = this.records;
  ...
  module('unloading/deleting records', function(hooks) {
    ...
    skip(
      'Unloading a record removes it from record arrays, which have reference to it',
      function(assert) {
        ...
        let booksInSeriesProjectedPreview = get(
          projectedPreview,
          'otherBooksInSeries'
        );
        let otherProjectedPreview = get(
          booksInSeriesProjectedPreview,
          'firstObject'
        );
